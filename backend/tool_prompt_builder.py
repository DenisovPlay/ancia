...
def build_enabled_tools_prompt(
  ...
  *,
  ...
  lines.extend([
    ...
    "- Если нужно несколько инструментов, верни несколько вызовов подряд (несколько `<tool_call>...</tool_call>` или JSON-массив вызовов).",
    "- После каждого результата можно вызывать следующий инструмент, пока не соберёшь все данные.",
